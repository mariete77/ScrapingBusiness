@echo off
echo =====================================================
echo   ENVIANDO WHATSAPP A RESTAURANTES - PROVINCIA DE A CORUÑA
echo =====================================================
echo.
echo Configuracion: whatsapp_config_coruna.json
echo CSV: se usara el mas reciente (restaurantes_coruna_provincia_sin_web_*.csv)
echo.
echo ========================================
...
C:\Users\mario\AppData\Local\Python\bin\python.exe ..\scripts\whatsapp_sender.py whatsapp_config_coruna.json
...
echo ========================================
echo.
echo Revisa el log: envios_whatsapp_coruna.log
echo.

@echo off
echo =====================================================
echo   ENVIANDO WHATSAPP A RESTAURANTES - PROVINCIA DE HUELVA
echo =====================================================
echo.
echo Configuracion: whatsapp_config_huelva.json
echo Archivo: restaurantes_huelva_provincia_sin_web_20260529_110756.csv
echo Total restaurantes: 286
echo.
echo ========================================
...
C:\Users\mario\AppData\Local\Python\bin\python.exe ..\scripts\whatsapp_sender.py whatsapp_config_huelva.json
